        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ url('items/store') }}" class="row g-3" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-4">
                        <label for="sku" class="form-label"><span class="text-danger">*</span>SKU</label>
                    ...
                    <div class="col-sm-4">
                        <label for="name" class="form-label"><span class="text-danger">*</span>Product Name</label>
                    ...
                    <div class="col-sm-4">
                        <label for="supplier_id" class="form-label"><span class="text-danger">*</span>Supplier</label>
                        {!! Form::select('supplier_id', $suppliers, null, ['id' => 'supplier_id', 'class' => 'form-control form-control-sm', 'placeholder' => 'Select Supplier']) !!}
                    </div>

                    <div class="col-sm-4">
                        <label for="unit" class="form-label"><span class="text-danger">*</span>Unit</label>
                        {!! Form::select('unit', $units, null, ['id' => 'unit', 'class' => 'form-control form-control-sm', 'placeholder' => 'Select Unit']) !!}
                    </div>

                    <div class="col-sm-4">
                        <label for="cost_price" class="form-label"><span class="text-danger">*</span>Cost Price</label>
                    ...
                    <div class="col-sm-4">
                        <label for="unit_price" class="form-label"><span class="text-danger">*</span>Retail Price</label>
                        <div class="input-group input-group-sm">
                            <div class="input-group-text">
                                Rp
                            </div>
                    ...
                    <div class="col-sm-4">
                        <label for="quantity" class="form-label"><span class="text-danger">*</span>Quantity Stock</label>
                    ...
                    <div class="col-sm-4">
                        <label for="loc" class="form-label"><span class="text-danger">*</span>Location</label>
                    ...
                    <div class="col-sm-4">
                        <label for="description" class="form-label"><span class="text-danger">*</span>Base Image</label>
