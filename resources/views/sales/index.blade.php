...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $("#item_search").autocomplete({
                ...
                select: function(event, ui) {
                    ...
                    $('table#items tbody').append(
                        ...
                        .id +
                        '"></td><td width="10%"><input tabindex="4" name="qty[]" class="qty" style="width: 100%" type="number" id="qty" value="1"></td><td width="10%"><input tabindex="5" name="dis[]" class="dis" style="width: 100%" type="number" id="dis" value="0"></td><td class="tot" id="total">' +
            ...
            $("table#items").on('change', 'input#qty,input#dis', function() {
                
                $("td#cost").attr('data-cost');
                $("#qty").val();
                var dis = $(this).parent().parent().children().find('input#dis').val();
                var cost = $(this).parent().parent().children().eq(2).text();
                //var qty = $(this).parent().parent().children().find('input#qty').val();
                var qty = $(this).val();
                //$(this).val(qty);
                //$(this).parent().parent().children().find('input#qty').val(qty);
                //$(this).parent().parent().children().find('input#dis').val(dis);
                
                var d = $(this).parent().parent().children().eq(5).text((cost * qty)-(cost * qty * dis/100));
                // console.log($(this).parent().parent().parent());
                $('table#employee th#total').text((cost * qty)-(cost * qty * dis/100));
                console.log("qty&dis: ",qty+"-"+dis);
