...
<div class="col-sm-4">
    <label for="email" class="form-label"><span class="text-danger">*</span>Phone Number</label>
    <div class="input-group">
        <div class="input-group-text">
...
<div class="col-sm-4">
    <label for="address1" class="form-label"><span class="text-danger">*</span>Address 1</label>
...
<div class="col-sm-4">
    <label for="zip" class="form-label"><span class="text-danger">*</span>Zip</label>
...
<div class="col-sm-4">
    <label for="company" class="form-label"><span class="text-danger">*</span>Company</label>
    {!! Form::text('company', null, ['id' => 'company', 'class' => 'form-control form-control-sm']) !!}
</div>
<div class="col-sm-4">
    <label for="account" class="form-label"><span class="text-danger">*</span>Account #</label>
...
<div class="col-sm-4">
    ...
    <div class="input-group input-group-sm">
        ...
        {!! Form::number('total', null, ['id' => 'total', 'class' => 'form-control form-control-sm']) !!}
    </div>
</div>

<div class="col-sm-4">
    <label for="discount" class="form-label"><span class="text-danger">*</span>Discount</label>
    <div class="input-group input-group-sm">
        {!! Form::number('discount', null, ['id' => 'discount', 'class' => 'form-control form-control-sm']) !!}
        <div class="input-group-text">
            %
        </div>
    </div>
